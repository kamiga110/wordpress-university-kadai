              ...
              <div class="col-lg-3 footer_col">
                <div class="footer_section footer_links">
                  <div class="footer_links_container">
                    <ul>
                      <li><a href="<?php echo home_url(); ?>/category/news.html">ニュース</a></li>
                      <li><a href="<?php echo home_url(); ?>/category/events.html">イベント</a></li>
                      <li><a href="<?php echo home_url(); ?>/category/courses.html">コース</a></li>
                      <li><a href="<?php echo home_url(); ?>/category/about.html">侍大学について</a></li>
                    </ul>
                  </div>
                </div>
              </div>
